...
public class StepDefinition extends TestRunner{
    ...
    @Then("^I should see \"([^\"]*)\"$")
	 public void i_should_see_element(String locator) throws IOException {
	...
	public void i_should_not_see_element(String locator) throws IOException {
	 ...
	 @When("^I enter \"([^\"]*)\" in \"([^\"]*)\"$")
	 public void i_enter_text(String val, String locator) throws IOException {
		 wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath(PropertiesReader.locator_Values(locator)))));
		 driver.findElement(By.xpath(PropertiesReader.locator_Values(locator))).sendKeys(val);
	 }
